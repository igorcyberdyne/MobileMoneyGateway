...
abstract class AbstractCollectionGateway extends AbstractMtnApiGateway implements CollectionGatewayInterface
{
    ...
    protected function getPayerMessage(): string
    {
        ...
        return AbstractTools::injectVariables("Le numéro [[number]] a été débité de [[amount]] {$this->getCurrency()}", $params);
    }
    ...
    protected function getPayeeNote(): string
    {
        ...
        return AbstractTools::injectVariables("[[amount]] {$this->getCurrency()} collecté sur le numéro [[number]]", $params);
    }
